            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="row match-height">
                    ...
                    <div class="col-md-4 col-xl-4">
                        <div class="card bg-primary text-white text-center">
                            <div class="card-body">
                                <a href="{{route('admin.weCares')}}" class="text-white">
                                    إهتمامنا
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-xl-4">
                        <div class="card bg-primary text-white text-center">
                            <div class="card-body">
                                <a href="{{route('admin.ourTeam')}}" class="text-white">
                                    فريق العمل
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-xl-4">
                        <div class="card bg-primary text-white text-center">
                            <div class="card-body">
                                <a href="{{route('admin.equipments')}}" class="text-white">
                                    الأجهزة والأدوات
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-xl-4">
                        <div class="card bg-primary text-white text-center">
                            <div class="card-body">
                                <a href="{{route('admin.news')}}" class="text-white">
                                    الأخبار و الأحداث
                                </a>
                            </div>
                        </div>
