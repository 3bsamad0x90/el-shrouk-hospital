                        ...
                        <tbody>
                            ...
                            <tr id="row_{{ $new->id }}">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php $delete = route('admin.news.delete',['id'=>$new->id]); ?>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    ...
                                    {{Form::open(['url'=>route('admin.news.update',['id'=>$new->id]), 'id'=>'editnewForm', 'class'=>'row gy-1 pt-75', 'files'=>true])}}
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    {{Form::open(['url'=>route('admin.news.store'), 'id'=>'createnewForm', 'class'=>'row gy-1 pt-75', 'files'=>true])}}
                        <div class="col-12 col-md-6">
                            <label class="form-label" for="title_ar">العنوان بالعربية</label>
